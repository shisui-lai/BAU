        ...
        children: [
          {
            ...
            component: () => import('@/views/Bcu/bcuParameter/bcuParameter.vue'),
            meta: { visibleForGuest: false } // 管理员才看得见
          },
          {
            path: 'alarmConfig',
            name: 'BCU-AlarmConfig',
            component: () => import('@/views/Bcu/bcuParameter/alarmConfig.vue'),
            meta: { visibleForGuest: false } // 管理员才看得见
          },
          {
            path: 'SOXConfig',
            name: 'BCU-SOXConfig',
            component: () => import('@/views/Bcu/bcuParameter/SOXConfig.vue'),
            meta: { visibleForGuest: false } // 管理员才看得见
          }
        ]
      },
