...
const rawModel = ref([
  {
    ...
    items: [
      ...
      { labelKey: 'menu.didoData', icon: 'pi pi-fw pi-chart-bar', to: '/Bcu/alarmData/DIDORTData' },
      ...
      { labelKey: 'menu.version', icon: 'pi pi-fw pi-chart-bar', to: '/Bcu/clusterData/version' }
    ]
  },
  ...
  },
  {
    ...
    icon: 'pi  pi-wrench',
    items: [
      { labelKey: 'menu.controlCommand', icon: 'pi pi-fw pi-wrench', to: '/Bcu/control/fet' },
      {
      ...
      { labelKey: 'menu.powerMap', icon: 'pi pi-fw pi-wrench', to: '/Bcu/control/powerMap' },
      /*       { labelKey: '强制均衡', icon: 'pi pi-fw pi-table', to: '/Bcu/control/balance' }, */
      { labelKey: 'menu.eventTime', icon: 'pi pi-fw pi-wrench', to: '/Bcu/eventRecord/event' },
      { labelKey: 'menu.upgrade', icon: 'pi pi-fw pi-wrench', to: '/Bcu/update/bcuUpdate' },
      { labelKey: 'menu.forceUpgrade', icon: 'pi pi-fw pi-upload', to: '/Bcu/update/bcuForceUpgrade' }
