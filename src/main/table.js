export const ALARM_MAP = {
  ...
  export const CLUSTER_SUMMARY = [
    ...
    {class:'系统信息', key:'SysTotal_Standby',         label:'禁充禁放',         type:'bit',  bitsOf:'SysTotalStatus_Word1', bit:5 },
...
export const SAVED_FAULT_MAP = [
  ...
  export const SYS_BASE_PARAM_R = [
    ...
    { class:'延时配置',  key:'contactorValue',     label:'接触器范围值',       type:'u16', scale:10, unit:'V' },
    { class:'延时配置',  key:'contactorDetectDelay',label:'接触器检测延时',    type:'u16', unit:'s' },

    /* ⑧ 预留 8 B -------------------------------------------------------- */
    { key:'_skip3', type:'skip8' },

    { class:'温控策略', key:'runCoolCond1MaxCellTemp', label:'运行模式-制冷条件1-最大单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runCoolCond2AvgCellTemp', label:'运行模式-制冷条件2-平均单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runCoolingSetPoint',      label:'运行模式-制冷点温度值',           type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runCoolingHysteresis',    label:'运行模式-制冷点回差值',           type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runHeatCond1MinCellTemp', label:'运行模式-制热条件1-最小单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runHeatCond2AvgCellTemp', label:'运行模式-制热条件2-平均单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runHeatingSetPoint',      label:'运行模式-制热点温度值',           type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'runHeatingHysteresis',    label:'运行模式-制热点回差值',           type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleCoolCond1MaxCellTemp', label:'非运行模式-制冷条件1-最大单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleCoolCond2AvgCellTemp', label:'非运行模式-制冷条件2-平均单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleCoolingSetPoint',      label:'非运行模式-制冷点温度值',       type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleCoolingHysteresis',    label:'非运行模式-制冷点回差值',       type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleHeatCond1MinCellTemp', label:'非运行模式-制热条件1-最小单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleHeatCond2AvgCellTemp', label:'非运行模式-制热条件2-平均单体温度限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleHeatingSetPoint',      label:'非运行模式-制热点温度值',       type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'idleHeatingHysteresis',    label:'非运行模式-制热点回差值',       type:'s16', scale:10, unit:'℃' },

    { key:'_skip4', type:'skip4' },

    { class:'温控策略', key:'shutdownCond1CellTempDiff', label:'停机条件1-单体温差限制值', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'shutdownCond2MaxCellTemp',  label:'停机条件2-最大单体温度限制值', type:'s16', scale:10, unit:'℃' },

    { key:'_skip5', type:'skip2' },

    { class:'温控策略', key:'fanStartTemp', label:'风扇开启温度', type:'s16', scale:10, unit:'℃' },
    { class:'温控策略', key:'fanStopTemp',  label:'风扇停止温度', type:'s16', scale:10, unit:'℃' },
    ...
    { class:'电池参数配置', key:'clusterCalibEnergy', label:'簇校正电量',    type:'u32', scale:100, unit:'kWh' },
    { class:'电池参数配置', key:'clusterRatedEnergy', label:'簇额定电量',    type:'u32', scale:100, unit:'kWh' },
    { class:'电池参数配置', key:'clusterRatedPower',  label:'簇额定功率',     type:'u32', scale:100, unit:'kW' },
    { class:'电池参数配置', key:'clusterRatedVoltage',  label:'簇额定电压',     type:'u16', scale:10, unit:'V' },
...
export const SOC_CFG_PARAM_R = [
  ...
  { class: 'SOC算法参数', key: 'socHighCalibUpperVolt', label: 'SOC高端校准下限电压', type: 'u16', scale: 1, unit: 'mV' },
  ...
  { class: 'SOC算法参数', key: 'catchUpTimeKnee', label: '放电拐点真实SOC追赶时间', type: 'u16', scale: 10, unit: 's' },
...
export const BLOCK_SUMMARY = [
  ...
  ...Array.from({ length: 10 }, (_, i) => ({ class: '状态信息', key: `Cluster${i + 1}_Enable`, label: `簇${i + 1}使能`, type: 'bit', bitsOf: 'EnableClusterStatus1', bit: i, hide: true })),
  ...Array.from({ length: 10 }, (_, i) => ({ class: '状态信息', key: `Cluster${i + 11}_Enable`, label: `簇${i + 11}使能`, type: 'bit', bitsOf: 'EnableClusterStatus2', bit: i, hide: true })),
  ...
  ...Array.from({ length: 10 }, (_, i) => ({ class: '状态信息', key: `Cluster${i + 1}_Cutout`, label: `簇${i + 1}切出`, type: 'bit', bitsOf: 'CutoutClusterStatus1', bit: i, hide: true })),
  ...Array.from({ length: 10 }, (_, i) => ({ class: '状态信息', key: `Cluster${i + 11}_Cutout`, label: `簇${i + 11}切出`, type: 'bit', bitsOf: 'CutoutClusterStatus2', bit: i, hide: true }))
];
...
export const BLOCK_VERSION = [
  ...
  { class: '版本信息', key: 'bauMergeSplitAlgorithmVersion', label: 'BAU-退并簇算法版本号', type: 'str20' },
...
export const BLOCK_COMM_DEV_CFG_R = [
  ...
  { class: '系统通讯设备配置参数', key: 'CoolingDeviceType', label: '制冷设备类型', type: 'u16', scale: 1, remarks: '0-无制冷设备 1-科诺威水冷机 2-英维克 3-埃森特交流空调 4-英维克-EMW30-50-80 5-均能水冷机-1' },
  { class: '系统通讯设备配置参数', key: 'CoolingDeviceCount', label: '制冷设备数量', type: 'u16', scale: 1 },
  { class: '系统通讯设备配置参数', key: 'DehumidifierType', label: '除湿空调类型', type: 'u16', scale: 1, remarks: '0-无除湿空调 1-除湿机-01 2-02-除湿机-E-J-000113' },
...
export const EN_CLUSTER_HARDWARE_SUM = [
  ...
  { class: '接触器故障', key: 'MainPosContactorFeedbackFault', label: '主正接触器反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 0 },
  { class: '接触器故障', key: 'MainPosHighSideFeedbackFault', label: '主正高边驱动反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 1 },
  { class: '接触器故障', key: 'MainPosOxidation', label: '主正氧化', type: 'bit', bitsOf: 'ContactorFault1', bit: 2 },
  { class: '接触器故障', key: 'MainPosAdhesion', label: '主正黏连', type: 'bit', bitsOf: 'ContactorFault1', bit: 3 },
  { class: '接触器故障', key: 'MainPosContactorFaultSummary', label: '主正接触器故障 汇总', type: 'bit', bitsOf: 'ContactorFault1', bit: 4 },
  { class: '接触器故障', key: 'MainNegContactorFeedbackFault', label: '主负接触器反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 5 },
  { class: '接触器故障', key: 'MainNegHighSideFeedbackFault', label: '主负高边驱动反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 6 },
  { class: '接触器故障', key: 'MainNegOxidation', label: '主负氧化', type: 'bit', bitsOf: 'ContactorFault1', bit: 7 },
  { class: '接触器故障', key: 'MainNegAdhesion', label: '主负黏连', type: 'bit', bitsOf: 'ContactorFault1', bit: 8 },
  { class: '接触器故障', key: 'MainNegContactorFaultSummary', label: '主负接触器故障 汇总', type: 'bit', bitsOf: 'ContactorFault1', bit: 9 },
  { class: '接触器故障', key: 'PrechargeContactorFeedbackFault', label: '预充接触器反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 10 },
  { class: '接触器故障', key: 'PrechargeHighSideFeedbackFault', label: '预充高边驱动反馈故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 11 },
  { class: '接触器故障', key: 'PrechargeOxidation', label: '预充氧化', type: 'bit', bitsOf: 'ContactorFault1', bit: 12 },
  { class: '接触器故障', key: 'PrechargeAdhesion', label: '预充黏连', type: 'bit', bitsOf: 'ContactorFault1', bit: 13 },
  { class: '接触器故障', key: 'PrechargeContactorFaultSummary', label: '预充接触器故障 汇总', type: 'bit', bitsOf: 'ContactorFault1', bit: 14 },
  { class: '接触器故障', key: 'ContactorFaultSummary', label: '汇总的故障', type: 'bit', bitsOf: 'ContactorFault1', bit: 15 },

  { class: '接触器故障', key: 'ContactorFault2', type: 'u16', scale: 1, hide: false },

  { class: '反馈故障', key: 'FeedbackFault1', type: 'u16', scale: 1, hide: false },
  { class: '反馈故障', key: 'IsolationSwitchFeedbackFault', label: '隔离开关反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 0 },
  { class: '反馈故障', key: 'CircuitBreakerFeedbackFault', label: '断路器反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 1 },
  { class: '反馈故障', key: 'FanFeedbackFault', label: '风扇反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 2 },
  { class: '反馈故障', key: 'DCPowerKMFeedbackFault', label: '直流供电KM反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 3 },
  { class: '反馈故障', key: 'AccessControlFeedbackFault', label: '门禁反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 4 },
  { class: '反馈故障', key: 'SPDFeedbackFault', label: 'SPD反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 5 },
  { class: '反馈故障', key: 'ACVoltageFeedbackFault', label: '交流电压反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 6 },
  { class: '反馈故障', key: 'SmokeSensorFeedbackFault', label: '烟感反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 7 },
  { class: '反馈故障', key: 'FireReleaseSignal', label: '消防释放信号', type: 'bit', bitsOf: 'FeedbackFault1', bit: 8 },
  { class: '反馈故障', key: 'TempSensorFeedbackFault', label: '温感反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 9 },
  { class: '反馈故障', key: 'ExhaustSystemFeedbackFault', label: '排风系统反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 10 },
  { class: '反馈故障', key: 'AuxCircuitBreakerFeedbackFault', label: '辅助断路器反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 11 },
  { class: '反馈故障', key: 'HydrogenDetectorFeedbackFault', label: '氢气探测器反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 12 },
  { class: '反馈故障', key: 'MSDFeedbackFault', label: 'MSD反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 13 },
  { class: '反馈故障', key: 'EmergencyStopFeedbackFault', label: '急停反馈故障', type: 'bit', bitsOf: 'FeedbackFault1', bit: 14 },
  { class: '反馈故障', key: 'FeedbackFault1Reserved', label: '', type: 'bit', bitsOf: 'FeedbackFault1', bit: 15, hide: true },

  { class: '反馈故障', key: 'FeedbackFault2', type: 'u16', scale: 1, hide: false },

  { class: '高边故障', key: 'HighSideFault1', type: 'u16', scale: 1, hide: false },
  { class: '高边故障', key: 'MainPosHighSideFeedbackFault2', label: '主正高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 0 },
  { class: '高边故障', key: 'MainNegHighSideFeedbackFault2', label: '主负高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 1 },
  { class: '高边故障', key: 'PrechargeHighSideFeedbackFault2', label: '预充高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 2 },
  { class: '高边故障', key: 'RedLampHighSideFeedbackFault', label: '红灯高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 3 },
  { class: '高边故障', key: 'YellowLampHighSideFeedbackFault', label: '黄灯高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 4 },
  { class: '高边故障', key: 'GreenLampHighSideFeedbackFault', label: '绿灯高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 5 },
  { class: '高边故障', key: 'FanHighSideFeedbackFault2', label: '风机高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 6 },
  { class: '高边故障', key: 'MainBreakerShuntHighSideFeedbackFault', label: '主断分励高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 7 },
  { class: '高边故障', key: 'DCPowerKMHighSideFeedbackFault2', label: '直流供电KM高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 8 },
  { class: '高边故障', key: 'PCSSealedWaveHighSideFeedbackFault', label: 'pcs封波高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 9 },
  { class: '高边故障', key: 'AuxCircuitBreakerControlHighSideFeedbackFault', label: '辅助断路器控制高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 10 },
  { class: '高边故障', key: 'ExhaustSystemControlHighSideFeedbackFault', label: '排风系统控制高边驱动反馈故障', type: 'bit', bitsOf: 'HighSideFault1', bit: 11 },
  { class: '高边故障', key: 'HighSideFault1Reserved', label: '', type: 'bit', bitsOf: 'HighSideFault1', bit: 12, hide: true },
  { class: '高边故障', key: 'HighSideFault1Reserved2', label: '', type: 'bit', bitsOf: 'HighSideFault1', bit: 13, hide: true },
  { class: '高边故障', key: 'HighSideFault1Reserved3', label: '', type: 'bit', bitsOf: 'HighSideFault1', bit: 14, hide: true },
  { class: '高边故障', key: 'HighSideFault1Reserved4', label: '', type: 'bit', bitsOf: 'HighSideFault1', bit: 15, hide: true },

  { class: '高边故障', key: 'HighSideFault2', type: 'u16', scale: 1, hide: false },

  { class: '通讯故障', key: 'CommFault', type: 'u16', scale: 1, hide: false },
  { class: '通讯故障', key: 'CoolingDeviceCommFault2', label: '制冷设备通信故障', type: 'bit', bitsOf: 'CommFault', bit: 0 },
  { class: '通讯故障', key: 'PCSCommFault2', label: 'PCS设备通信故障', type: 'bit', bitsOf: 'CommFault', bit: 1 },
  { class: '通讯故障', key: 'DehumidifierCommFault2', label: '除湿机通信故障', type: 'bit', bitsOf: 'CommFault', bit: 2 },
  { class: '通讯故障', key: 'FireDeviceCommFault2', label: '消防设备通信故障', type: 'bit', bitsOf: 'CommFault', bit: 3 },
  { class: '通讯故障', key: 'BMUCommFault2', label: 'BMU通信故障', type: 'bit', bitsOf: 'CommFault', bit: 4 },
  { class: '通讯故障', key: 'CANHallCommFault2', label: 'CAN霍尔通信故障', type: 'bit', bitsOf: 'CommFault', bit: 5 },
  { class: '通讯故障', key: 'BCUCommFault2', label: 'BCU通信故障', type: 'bit', bitsOf: 'CommFault', bit: 6 },
  { class: '通讯故障', key: 'DaisyChainCommFault', label: '菊花链通信故障', type: 'bit', bitsOf: 'CommFault', bit: 7 },
  { class: '通讯故障', key: 'AFECommFault2', label: 'afe通信故障', type: 'bit', bitsOf: 'CommFault', bit: 8 },
  { class: '通讯故障', key: 'CommFaultReserved', label: '', type: 'bit', bitsOf: 'CommFault', bit: 9, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved2', label: '', type: 'bit', bitsOf: 'CommFault', bit: 10, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved3', label: '', type: 'bit', bitsOf: 'CommFault', bit: 11, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved4', label: '', type: 'bit', bitsOf: 'CommFault', bit: 12, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved5', label: '', type: 'bit', bitsOf: 'CommFault', bit: 13, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved6', label: '', type: 'bit', bitsOf: 'CommFault', bit: 14, hide: true },
  { class: '通讯故障', key: 'CommFaultReserved7', label: '', type: 'bit', bitsOf: 'CommFault', bit: 15, hide: true },

  { class: '温度传感器故障', key: 'TempSensorFault2', type: 'u16', scale: 1, hide: false },
  { class: '温度传感器故障', key: 'BCUEnvSensorFault2', label: 'bcu环境传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 0 },
  { class: '温度传感器故障', key: 'BPosSensorFault2', label: 'B+传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 1 },
  { class: '温度传感器故障', key: 'BNegSensorFault2', label: 'B-传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 2 },
  { class: '温度传感器故障', key: 'PPosSensorFault2', label: 'P+传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 3 },
  { class: '温度传感器故障', key: 'PNegSensorFault2', label: 'P-传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 4 },
  { class: '温度传感器故障', key: 'Fuse1TempSensorFault2', label: '熔断器1传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 5 },
  { class: '温度传感器故障', key: 'Fuse2TempSensorFault2', label: '熔断器2传感器故障', type: 'bit', bitsOf: 'TempSensorFault2', bit: 6 },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 7, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved2', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 8, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved3', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 9, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved4', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 10, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved5', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 11, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved6', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 12, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved7', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 13, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved8', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 14, hide: true },
  { class: '温度传感器故障', key: 'TempSensorFaultReserved9', label: '', type: 'bit', bitsOf: 'TempSensorFault2', bit: 15, hide: true },

  { class: '其他故障', key: 'OtherFault1', type: 'u16', scale: 1, hide: false },
  { class: '其他故障', key: 'HallFault2', label: '霍尔故障', type: 'bit', bitsOf: 'OtherFault1', bit: 0 },
  { class: '其他故障', key: 'InvalidDataPresent2', label: '存在无效数据', type: 'bit', bitsOf: 'OtherFault1', bit: 1 },
  { class: '其他故障', key: 'FRAMFault2', label: '铁电存储器故障', type: 'bit', bitsOf: 'OtherFault1', bit: 2 },
  { class: '其他故障', key: 'EEPROMFault2', label: 'eeprom存储器故障', type: 'bit', bitsOf: 'OtherFault1', bit: 3 },
  { class: '其他故障', key: 'FlashFault2', label: 'flash存储器故障', type: 'bit', bitsOf: 'OtherFault1', bit: 4 },
  { class: '其他故障', key: 'VoltageAcqDisconnected2', label: '电压采集断线', type: 'bit', bitsOf: 'OtherFault1', bit: 5 },
  { class: '其他故障', key: 'TempAcqDisconnected2', label: '温度采集断线', type: 'bit', bitsOf: 'OtherFault1', bit: 6 },
  { class: '其他故障', key: 'ReservedFault2', label: '保留故障', type: 'bit', bitsOf: 'OtherFault1', bit: 7 },
  { class: '其他故障', key: 'OtherFault1Reserved', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 8, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved2', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 9, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved3', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 10, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved4', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 11, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved5', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 12, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved6', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 13, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved7', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 14, hide: true },
  { class: '其他故障', key: 'OtherFault1Reserved8', label: '', type: 'bit', bitsOf: 'OtherFault1', bit: 15, hide: true },

  { class: '其他故障', key: 'OtherFault2', type: 'u16', scale: 1, hide: false },
  { class: '其他故障', key: 'BMUDeviceCommFault2', label: 'BMU设备通讯故障', type: 'bit', bitsOf: 'OtherFault2', bit: 0 },
  { class: '其他故障', key: 'SingleCellDropped2', label: '单体电池掉线', type: 'bit', bitsOf: 'OtherFault2', bit: 1 },
  { class: '其他故障', key: 'SingleTempProbeDropped2', label: '单体温度探头掉线', type: 'bit', bitsOf: 'OtherFault2', bit: 2 },
  { class: '其他故障', key: 'BMU1PowerConnectorTempDisconnected2', label: 'BMU 1号 动力接插件温度断线', type: 'bit', bitsOf: 'OtherFault2', bit: 3 },
  { class: '其他故障', key: 'BMU2PowerConnectorTempDisconnected2', label: 'BMU 2号 动力接插件温度断线', type: 'bit', bitsOf: 'OtherFault2', bit: 4 },
  { class: '其他故障', key: 'AFECommLost2', label: 'AFE通讯失联', type: 'bit', bitsOf: 'OtherFault2', bit: 5 },
  { class: '其他故障', key: 'BCUCommFault22', label: 'BCU通讯故障', type: 'bit', bitsOf: 'OtherFault2', bit: 6 },
  { class: '其他故障', key: 'OtherFault2Reserved', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 7, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved2', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 8, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved3', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 9, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved4', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 10, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved5', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 11, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved6', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 12, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved7', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 13, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved8', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 14, hide: true },
  { class: '其他故障', key: 'OtherFault2Reserved9', label: '', type: 'bit', bitsOf: 'OtherFault2', bit: 15, hide: true },
]
