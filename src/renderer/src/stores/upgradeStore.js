  ...
  const buildUpgradeParamData = () => {
    try {
      ...
      if (upgradeType === '0xA000') {
        ...
        // BCU升级：填充簇选择，BMU相关为0
        upgradeParamData.bcuSelection1 = buildClusterSelection(upgradeParams.value.bcuSelection1 || [])
        upgradeParamData.bcuSelection2 = buildClusterSelection(upgradeParams.value.bcuSelection2 || [])
