            ...
            <div class="config-section">
              ...
              <div class="button-row">
                <button
                  ...
                  class="btn btn-primary config-button"
                >
                  <i class="pi pi-play"></i>
                  <span>{{ bcuStatus.isExecuting ? t('addressAdaptive.labels.executing') : t('addressAdaptive.labels.startBcuAdaptive') }}</span>
                </button>
              </div>
            </div>
            ...
            <div class="config-section">
              <div class="form-row">
                ...
                <select
                  ...
                  class="native-select cluster-dropdown"
                >
              ...
              <div class="button-row">
                ...
                >
                  <i class="pi pi-play"></i>
                  <span>{{ bmuStatus.isExecuting ? t('addressAdaptive.labels.executing') : t('addressAdaptive.labels.startBmuAdaptive') }}</span>
                </button>
              </div>
            </div>
