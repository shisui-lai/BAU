...
const JUNNENG_WATER_CHILLER_1_SPEC = [
  ...
  { reg: 65, key: 'fanFaultStatusFan1', label: '风扇故障状态-风机1', type: 'bits', bit: 0, len: 1, map: { 0: '正常', 1: '故障' } },
  { reg: 65, key: 'fanFaultStatusFan2', label: '风扇故障状态-风机2', type: 'bits', bit: 4, len: 1, map: { 0: '正常', 1: '故障' } },
  { reg: 65, key: 'fanFaultStatusFan3', label: '风扇故障状态-风机3', type: 'bits', bit: 8, len: 1, map: { 0: '正常', 1: '故障' } },
  { reg: 65, key: 'fanFaultStatusFan4', label: '风扇故障状态-风机4', type: 'bits', bit: 12, len: 1, map: { 0: '正常', 1: '故障' } },
