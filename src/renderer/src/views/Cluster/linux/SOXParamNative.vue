...
// 添加SOX参数页面的类型映射
//addPageTypeMapping('/Cluster/SOXParamNative', 'cluster')
      ...
      <div class="control-area mb-3">
        <div class="control-left">
          <div class="button-group">
            ...
            >
              {{ isCurrentlyReading ? t('soxParam.buttons.stopReading') : t('soxParam.buttons.startReading') }}
            </button>
            <button
            ...
            >
              {{ t('soxParam.buttons.sendParameters') }}
            </button>
          </div>
        </div>
      </div>
