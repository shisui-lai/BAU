...
// 已移除 PrimeVue 组件导入（Button, Password, InputText, InputNumber, Dropdown），使用原生 HTML 元素，保留 Dialog
...
function handleInterfaceChange(event) {
  ...
  const found = localizedInterfaces.value.find(iface => iface.name === selectedName)
  selectedInterface.value = found || null
}
              ...
              <div class="network-selector-content">
                <div class="network-selector-wrapper">
                  ...
                  <select
                    ...
                    class="native-select network-dropdown"
                    :disabled="isLoadingInterfaces"
                  >
                    <option value="" disabled>
                      {{ isLoadingInterfaces 
                        ? (te('bauAddressDetectionPage.placeholders.loadingInterfaces') 
                           ? t('bauAddressDetectionPage.placeholders.loadingInterfaces') 
                           : '加载中...')
                        : t('bauAddressDetectionPage.placeholders.selectNetworkInterface') }}
                    </option>
                    <option
                      v-for="iface in localizedInterfaces"
                      :key="iface.name"
                      :value="iface.name"
                    >
                      {{ iface.displayName }}
                  ...
                  <i class="pi pi-refresh refresh-icon"
                     ...
                     :title="t('bauAddressDetectionPage.tooltips.refreshInterfaces')"></i>
                </div>
              </div>
            </div>
              ...
              <div class="section-header">
                ...
                <div class="header-controls">
                  <button
                    ...
                    :disabled="ip1Query.isQuerying"
                    class="btn btn-secondary query-button"
                  >
                    <i v-if="ip1Query.isQuerying" class="pi pi-spin pi-spinner"></i>
                    <span>{{ t('bauAddressDetectionPage.buttons.query') }}</span>
                  </button>
                </div>
              </div>
              ...
              <div class="section-header">
                ...
                <div class="header-controls">
                  <button
                    ...
                    :disabled="ip2Query.isQuerying"
                    class="btn btn-secondary query-button"
                  >
                    <i v-if="ip2Query.isQuerying" class="pi pi-spin pi-spinner"></i>
                    <span>{{ t('bauAddressDetectionPage.buttons.query') }}</span>
                  </button>
                </div>
              </div>
              ...
              <div class="section-header">
                ...
                <div class="header-controls">
                  <button
                    ...
                    :disabled="mqttQuery.isQuerying"
                    class="btn btn-secondary query-button"
                  >
                    <i v-if="mqttQuery.isQuerying" class="pi pi-spin pi-spinner"></i>
                    <span>{{ t('bauAddressDetectionPage.buttons.query') }}</span>
                  </button>
                </div>
              </div>
          ...
          <div class="table-content">
              ...
              <div class="ip-config-container">
                ...
                <div class="ip-config-item">
                  ...
                  <div class="button-row">
                    ...
                    >
                      ...
                      <span>{{ t('bauAddressDetectionPage.buttons.applyIp1Config') }}</span>
                    </button>
                  </div>
                </div>
                ...
                <div class="ip-config-item">
                  ...
                  <div class="button-row">
                    ...
                    >
                      <i class="pi pi-check"></i>
                      <span>{{ t('bauAddressDetectionPage.buttons.applyIp2Config') }}</span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            <div class="config-section">
              ...
              <div class="button-row">
                ...
                >
                  <i class="pi pi-check"></i>
                  <span>{{ t('bauAddressDetectionPage.buttons.applyMqttConfig') }}</span>
                </button>
              </div>
            </div>
            ...
            <div class="config-section">
              ...
              <div class="reset-buttons">
                ...
                >
                  ...
                  <span>{{ t('bauAddressDetectionPage.buttons.resetParams') }}</span>
                </button>
                <button
                  @click="resetDevice"
                ...
                >
                  ...
                  <span>{{ t('bauAddressDetectionPage.buttons.rebootDevice') }}</span>
                </button>
              </div>
            </div>
    ...
    >
      ...
      <template #footer>
        ...
        >
          ...
          <span>{{ t('bauAddressDetectionPage.buttons.cancel') }}</span>
        </button>
        <button
        ...
        >
          <i class="pi pi-check"></i>
          <span>{{ t('bauAddressDetectionPage.buttons.confirm') }}</span>
        </button>
      </template>
    </Dialog>
  </div>
